...
cd build
set project project
create_project -part xczu7ev-ffvc1156-2-i ${project} ${project}
cd $project
...
# add_files [glob ../../examples/project.srcs/sources_1/imports/new/*.v]
add_files -fileset constrs_1 [glob ../../examples/project.srcs/constrs_1/imports/new/*.xdc]
import_files
...
write_hw_platform -fixed -include_bit -file system.xsa
