...
public:
	...
	void update(long long total, long long low, long long high,
		    char symbol);
	virtual void shift() = 0;
	virtual void underflow() = 0;

	long long
		m_low; // Low end of this arithmetic coder's current range. Conceptually has an infinite number of trailing 0s.
	long long
		m_high; // High end of this arithmetic coder's current range. Conceptually has an infinite number of trailing 1s.
};
